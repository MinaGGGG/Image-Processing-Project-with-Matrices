 ...
 */
Image convertToGrayscale(const Image& input) {      // Mina
 ...
 */
Image flipHorizontal(const Image& input) {   // Rahma
    int height = input.getHeight();
    int width = input.getWidth();
 ...
 * 3. Return the flipped image
 */
Image flipVertical(const Image& input) {  //Rahma
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 */
Image adjustBrightness(const Image& input, int value) {   //Ahmed
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 * 3. Return the adjusted image
 */
Image adjustContrast(const Image& input, float factor) {  //Ahmed
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 */
Image applyBlur(const Image& input) {   //George  // Mina
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 */
Image rotate90(const Image& input) {   //Abdo  // Ahmed
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
